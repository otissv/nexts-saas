...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stripe_customer_id_idx" ON "app"."customers" ("stripe_customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "provider_id_oauth_providers_idx" ON "app"."oauth_providers" ("provider_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tenant_id_oauth_providers_idx" ON "app"."oauth_providers" ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "slug_idx" ON "app"."products" ("slug");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "username_users_idx" ON "app"."users" ("username");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tenant_id_users_idx" ON "app"."users" ("tenant_id");--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "app"."oauth_providers" ADD CONSTRAINT "oauth_providers_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "app"."tenants"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "app"."subscriptions" ADD CONSTRAINT "subscriptions_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "app"."tenants"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "app"."users" ADD CONSTRAINT "users_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "app"."tenants"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
